...
const CreateProfile = ({ onProfileCreated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      Swal.fire({
        ...
        text: 'We couldn\'t create a new profile. Please check if a profile already exists.',
      });
    }
  };
  ...
  return (
    <div className="p-6 max-w-lg mx-auto bg-white rounded-2xl shadow-md border border-gray-200">
      <h1 className="text-2xl mb-2 font-bold">Create Your Profile</h1>
      <h1 className="text-sm mb-6 text-gray-400">Create your profile to continue using SyncroApp!</h1>
